...
<template>
	...
	>
		...
		<rect x="11" y="17" width="2" height="4" fill="var(--label-color)" />
		<rect x="17" y="11" width="4" height="2" fill="var(--label-color)" />
		<rect x="3" y="11" width="4" height="2" fill="var(--label-color)" />
	</svg>
</template>
